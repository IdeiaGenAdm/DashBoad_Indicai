    ...
    <div className="relative w-full overflow-auto rounded-xl">
      <Table
        ...
        className={cn(
          ...
          '[&_tbody_tr:nth-child(even)]:bg-primary/5 dark:[&_tbody_tr:nth-child(even)]:bg-primary/10 [&_tbody_tr:nth-child(odd)]:bg-muted/50',
...
>(({ className, ...props }, ref) => <TableHeader ref={ref} className={className} {...props} />)
