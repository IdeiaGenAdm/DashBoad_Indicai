...
- **Estrutura modular por domínio**: `app/(private)/[feature]/` (ex.: usuarios, avaliacoes, banners), `components/features/[feature]/` para componentes específicos, `services/admin-[feature]-fetch.ts` por área; um módulo por domínio admin.
